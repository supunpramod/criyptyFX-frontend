    ...
    <div className="min-h-screen bg-gradient-to-r from-gray-900 to-black text-white px-4 sm:px-20 py-4">
        ...
        <div className="w-full flex flex-wrap md:flex-nowrap items-center justify-between space-y-4 md:space-y-0">
          <div className="w-full flex flex-wrap md:flex-nowrap items-center justify-between">
            ...
            <div className="hidden md:flex space-x-8">
              <button className="text-white hover:text-yellow-400">Buy Crypto</button>
              <button className="text-white hover:text-yellow-400">Trade</button>
              <button className="text-white hover:text-yellow-400">NFT</button>
              <button className="text-white hover:text-yellow-400">More</button>
            </div>
            {/* Actions */}
            <div className="flex items-center space-x-4 flex-wrap justify-end">
              <button className="border border-cyan-500 text-cyan-500 px-4 py-1.5 rounded-full hover:bg-cyan-500/10">
                Select Language
              </button>
              <button className="border border-cyan-500 text-cyan-500 px-4 py-1.5 rounded-full hover:bg-cyan-500/10">
                Sign In
              ...
              <div className="bg-cyan-500/20 rounded-full p-0.5 flex">
                <button className="bg-cyan-500 text-white px-6 py-1.5 rounded-full">Real</button>
                <button className="text-white px-6 py-1.5 hover:text-cyan-400">Demo</button>
              </div>
              <button className="bg-cyan-500 text-white px-6 py-1.5 rounded-full hover:bg-cyan-600 flex items-center space-x-2">
      ...
      <div className="relative flex flex-col md:flex-row items-center px-4 sm:px-8 py-16 md:py-12">
        ...
        <div className="w-full md:w-1/2 z-10 flex flex-col items-start md:items-start">
          ...
          <button className="bg-cyan-500 text-white px-8 py-3 rounded-full font-semibold shadow-lg hover:bg-yellow-500 transition">
            Start Trading
          </button>
          {/* Logos Section */}
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400">
              ...
              ipsum lectus, congue d turpis a, bibendum finibus ligula. Nam arcu
              nunc, dapibus in condimentum non, interdum efferitur justo.
            </p>
            <button className="bg-cyan-500 text-white px-8 py-3 rounded-full font-semibold shadow-lg hover:bg-yellow-500 transition">
              Start trading
            </button>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-slate-800/60 p-6 rounded-xl backdrop-blur-sm border border-slate-700/50 hover:bg-slate-800/80 transition-all cursor-pointer">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-gray-400 text-sm">
                  Verify your bank account in East way
                </p>
              </div>
            </div>
